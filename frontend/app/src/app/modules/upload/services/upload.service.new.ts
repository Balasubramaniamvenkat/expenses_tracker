...
/**
 * Mock implementation of the UploadService
 * This service simulates backend interactions for the file upload functionality
 */
@Injectable({
  providedIn: 'root'
})
export class UploadService {
  ...
  constructor(private http: HttpClient) {
    console.log('Mock UploadService initialized');
  }
